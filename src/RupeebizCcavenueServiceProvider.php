...
class RupeebizCcavenueServiceProvider extends ServiceProvider
{
    /**
    ...
    public function boot()
    {
        ...
        if ($this->app->runningInConsole()) {
            ...
            // Publishing assets.
            /*$this->publishes([
                __DIR__.'/../resources/assets' => public_path('vendor/rupeebiz-ccavenue'),
            ], 'assets');*/

            // Publishing the translation files.
            /*$this->publishes([
                __DIR__.'/../resources/lang' => resource_path('lang/vendor/rupeebiz-ccavenue'),
            ], 'lang');*/
